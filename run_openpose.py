...
from entimement_openpose.openpose_parts import OpenPosePartGroups, OpenPoseParts
...
@click.option('--body-parts', default=None,
              ...
              '--lower-body-parts.')
@click.option('--upper-body-parts', 'bodypartsgroup', flag_value='upper',
              default=True)
...
def openpose_cli(output_dir, openpose_dir, input_video,
                 ...
                 create_overlay_video, width, height, confidence_threshold,
                 body_parts, bodypartsgroup):
    """Runs openpose on the video, does post-processing, and outputs CSV
       files."""

    if body_parts:
        try:
            body_parts_list = [OpenPoseParts(part) for part in body_parts.split(',')]
    ...
    run_openpose(output_dir, openpose_dir, input_video,
                 ...
                 width, height, confidence_threshold, body_parts_list)
...
def run_openpose(output_dir, openpose_dir=None, input_video=None,
                 ...
                 confidence_threshold=0, body_parts=None):
