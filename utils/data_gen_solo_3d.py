...
## the csv contains one person's 3d skeleton                    ##
##                                                              ##
##################################################################
...
def generate_json(df, file):
    ...
    for ii in range(len(df)):
        ...
        data['skeleton'] = []
        skeleton = dict()
        skeleton['pose'] = [row['Nose']['x'], row['Nose']['y'], row['Nose']['z'],
                            row['Neck']['x'], row['Neck']['y'], row['Neck']['z'],
                            row['RShoulder']['x'], row['RShoulder']['y'],row['RShoulder']['z'],
                            row['RElbow']['x'], row['RElbow']['y'], row['RElbow']['z'],
                            row['RWrist']['x'], row['RWrist']['y'], row['RWrist']['z'],
                            row['LShoulder']['x'], row['LShoulder']['y'], row['LShoulder']['z'],
                            row['LElbow']['x'], row['LElbow']['y'], row['LElbow']['z'],
                            row['LWrist']['x'], row['LWrist']['y'], row['LWrist']['z'],
                            row['REye']['x'], row['REye']['y'], row['REye']['z'],
                            row['LEye']['x'], row['LEye']['y'], row['LEye']['z'],
                            row['MidHip']['x'], row['MidHip']['y'], row['MidHip']['z']
                            ]
        
        skeleton['score'] = [row['Nose']['c'],
                             row['Neck']['c'],
                             row['RShoulder']['c'],
                             row['RElbow']['c'],
                             row['RWrist']['c'],
...
csv_dir = '../data/CSV_solo_3d/'
# path for the output dir
output_label_dir = '../music_solo_3d/'
