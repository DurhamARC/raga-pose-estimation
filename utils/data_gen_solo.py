...
def generate_json(df, file):
    ...
    for ii in range(len(df)):
        ...
        data['skeleton'] = []
        skeleton = dict()
        skeleton['pose'] = [row['Nose']['x'], row['Nose']['y'],
                            row['Neck']['x'], row['Neck']['y'],
                            row['RShoulder']['x'], row['RShoulder']['y'],
                            row['RElbow']['x'], row['RElbow']['y'],
                            row['RWrist']['x'], row['RWrist']['y'],
                            row['LShoulder']['x'], row['LShoulder']['y'],
                            row['LElbow']['x'], row['LElbow']['y'],
                            row['LWrist']['x'], row['LWrist']['y'],
                            row['REye']['x'], row['REye']['y'],
                            row['LEye']['x'], row['LEye']['y'],
                            row['MidHip']['x'], row['MidHip']['y']
                            ]
